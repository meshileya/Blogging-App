 ...
 */
public class RecycleBin extends BaseActivity.BaseFragment implements View.OnClickListener{
                ...
                .addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            ...
                            showSnackBar(rootView.findViewById(R.id.cl_snack_bar), "Authentication", Snackbar.LENGTH_SHORT);
                        }
                        hideProgressDialog();
                    }
                });
